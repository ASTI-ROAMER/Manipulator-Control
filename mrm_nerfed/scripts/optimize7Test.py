...
def solveAnglesfromXYZ():
	...
	command_position2 = JointState()
	command_position2.header = Header()
	command_position2.header.stamp = rospy.Time.now()
	command_position2.name = ['link_1_joint', 'link_2_joint', 'link_3_joint', 'link_4_joint']
	command_position2.position = [q_Results[0], q_Results[1], q_Results[2], q_Results[3]]
	command_position2.velocity = []
	command_position2.effort = []
	pub.publish(command_position2)
